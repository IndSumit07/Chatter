    ...
    return (
        <section className="w-full bg-[#2e1065] py-20 px-4 overflow-hidden relative">
            <div className="max-w-7xl mx-auto flex flex-col items-center">
                ...
                <div className="relative w-full max-w-5xl aspect-auto md:aspect-video min-h-[600px] md:min-h-0 bg-white rounded-3xl p-4 md:p-6 shadow-2xl border-4 border-white/10 flex flex-col">
                    {/* Top Bar */}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-full min-h-0">
                        ...
                        <div className="md:col-span-3 flex flex-col gap-3 relative h-full">
                            ...
                            {[
                                ...
                                <div
                                    key={index}
                                    className={`p-4 rounded-xl flex items-center gap-3 transition-all duration-300 border-2 flex-1 ${activeTab === index ? `${item.color} border-black shadow-[4px_4px_0px_0px_#000000] scale-[1.02] -translate-y-1` : 'bg-gray-50 border-transparent opacity-60 hover:opacity-100 hover:bg-white hover:border-gray-200 hover:shadow-sm'} cursor-pointer`}
                        ...
                        <div className="md:col-span-9 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-300 relative overflow-hidden flex flex-col min-h-[400px] md:min-h-0 h-full">

                            {/* Text Mode Content */}
                            <div className={`absolute inset-0 flex flex-col transition-all duration-500 bg-gray-50 ${activeTab === 0 ? 'opacity-100 z-20 translate-x-0' : 'opacity-0 z-0 translate-x-4 pointer-events-none'}`}>
                                {/* Messages Area */}
                            ...
                            {/* Voice Mode Content */}
                            <div className={`absolute inset-0 p-8 flex items-center justify-center transition-all duration-500 bg-gray-50 ${activeTab === 1 ? 'opacity-100 z-20 translate-x-0' : 'opacity-0 z-0 translate-x-4 pointer-events-none'}`}>
                            ...
                            {/* Video Mode Content */}
                            <div className={`absolute inset-0 p-4 transition-all duration-500 bg-gray-50 ${activeTab === 2 ? 'opacity-100 z-20 translate-x-0' : 'opacity-0 z-0 translate-x-4 pointer-events-none'}`}>
                    ...
                    <div className="absolute -bottom-8 -left-4 md:left-8 bg-white py-2 px-4 rounded-full border-2 border-black shadow-lg flex items-center gap-[-8px] animate-float-gentle z-30" style={{ animationDelay: '2.5s' }}>
                    ...
                    <div className="absolute -bottom-12 -right-10 z-10 opacity-60 pointer-events-none">
                        <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="animate-spin-slow">
                            <path d="M50 0C50 27.6142 27.6142 50 0 50C27.6142 50 50 72.3858 50 100C50 72.3858 72.3858 50 100 50C72.3858 50 50 27.6142 50 0Z" fill="#d8b4fe" />
                        </svg>
                    </div>
